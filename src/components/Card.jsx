...
function Card({ creator, onDelete }) {
  ...
  const handleDelete = (e) => {
    ...
    if (confirmed) onDelete(creator.id)
  }
  ...
  return (
    <div className="card" onClick={() => navigate(`/creator/${creator.id}`)}>
      ...
      <div className="card-actions">
        <button className="icon-btn edit-icon" onClick={handleEdit}>Edit</button>
        <button className="icon-btn delete-icon" onClick={handleDelete}>Delete</button>
      </div>
